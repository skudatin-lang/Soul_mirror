                        ...
                        <div class="header-text">
                            ...
                            <div class="screen-subtitle-container">
                                <p class="screen-subtitle-description">
                                    Это не просто формальность — это ритуал начала.<br>
                                    Здесь ты подтверждаешь: «Да, я готов принять своё Зеркало Души».<br>
                                    После подписания и оплаты мы немедленно начнём создавать твой персональный артефакт целостности — и уже через 24 часа ты увидишь первые образы.<br>
                                    Всё, что нужно — указать имя и согласиться с условиями. Остальное — за нами. После формирования договора, ты перейдёшь к безопасной оплате через ЮKassa.<br>
